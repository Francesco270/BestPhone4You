<?php
    ...
    {
        if($row->capacitaBatteria == 1)
        {
            $large_battery_smartphones_count++;
            break; // if at least one smartphone has a battery larger than 4000mA, this loop can be interrupted earlier
        }
    }

    // Display the question only if there is at least one smartphone with a battery larger than 4000mA
